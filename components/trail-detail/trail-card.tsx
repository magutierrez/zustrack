...
export function TrailCard({
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white transition-all duration-300 hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-xl dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700"
    >
      {/* Map image hero */}
      <div className="relative aspect-2/1 overflow-hidden bg-zinc-200 dark:bg-zinc-800" data-trail-img={trail.id}>
        {/* Skeleton */}
        {!imgLoaded && (
