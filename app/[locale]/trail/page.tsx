      ...
      <main className="mx-auto max-w-4xl px-4 py-20">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-8 transition-all hover:border-blue-500 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-blue-500"
          >
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-8 transition-all hover:border-emerald-500 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-emerald-500"
          >
            <div className="flex flex-col items-center text-center">
              <div className="mb-4 rounded-full bg-emerald-100 p-4 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400">
                <MountainSnow className="size-8" />
              </div>
              <h2 className="mb-2 text-2xl font-semibold text-zinc-900 dark:text-white">
                {t('countryName.it')}
              </h2>
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-8 transition-all hover:border-amber-500 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-amber-500"
          >
            <div className="flex flex-col items-center text-center">
